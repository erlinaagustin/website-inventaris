    ...
    <script src="<?php echo base_url(); ?>/sb_admin/js/sb-admin-2.min.js"></script>
    ...
    <script src="<?php echo base_url(); ?>/sb_admin/js/demo/chart-pie-demo.js"></script>


    <!-- Page level plugins -->
    <script src="<?php echo base_url(); ?>/sb_admin/vendor/datatables/jquery.dataTables.min.js"></script>
    <script src="<?php echo base_url(); ?>/sb_admin/vendor/datatables/dataTables.bootstrap4.min.js"></script>
